...
class NLPSearch:
    ...
    def semantic_search(self, query, top_n=10, threshold=None):
        ...
        _, indices = index.search(query_vector, top_n * 2)  # Get extra results for filtering
        similarities = cosine_similarity(query_vector, self.embedding_matrix[indices[0]])[0]
        ...
        # Get product data for the top results
